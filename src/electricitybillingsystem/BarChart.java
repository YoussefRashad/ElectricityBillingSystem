...
public final class BarChart extends JFrame {
    ...
    public BarChart(String title , String []Region , int []n,String strSquare,String y_axis,String x_axis) {
        super(title);
        this.ChartTitle=title;
        final CategoryDataset dataset = CreateDataSet(Region, n,strSquare);
