...
public class LoginCustomer extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jLabelwrong2 = new javax.swing.JLabel();
        jLabelwrong1 = new javax.swing.JLabel();
        ...
        jLabelwrong2.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabelwrong2.setForeground(java.awt.Color.red);
        jLabelwrong2.setText("Wrong Input");

        jLabelwrong1.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabelwrong1.setForeground(java.awt.Color.red);
        jLabelwrong1.setText("Wrong Input");
        ...
        jLabel4.setText("Customer Control ... !");
            ...
            if(v.checkEmail(jTextField1.getText())){
                if(v.checkPass(jPasswordField1.getText())){
                    ...
                    if(x.LogIn(jTextField1.getText(), jPasswordField1.getText()))
                    {
                        ...
                        JOptionPane.showMessageDialog(jLabel7, "Email OR Password is Wrong OR both are Wrong ,Try Again :(");
                        jPanelWrongEmail.setVisible(false);
                        jPanelWrongPass.setVisible(false);
                    }
                }
                else{
                    JOptionPane.showMessageDialog(jLabel7, "Not valid Password length ,Should it Length\nis more than 6 OR Password has (*,/,=,+,...)\n                    Try Again :(");
                    jPanelWrongPass.setVisible(true);
                }
            }
            else{
                JOptionPane.showMessageDialog(jLabel7, "Not valid Input for Email Try Again :(");
...
private void setColor(JPanel p)
            ...
            if(v.checkEmail(jTextField1.getText())){
                if(v.checkPass(jPasswordField1.getText())){
                    ...
                    if(x.LogIn(jTextField1.getText(), jPasswordField1.getText()))
                    {
                        ...
                        jLabel4.setText("Invalid ... !  Please try again");
                        JOptionPane.showMessageDialog(jPanelLogin, "Email OR Password is Wrong OR both are Wrong ,Try Again :(");
                        jPanelWrongEmail.setVisible(false);
                        jPanelWrongPass.setVisible(false);
                    }
                }
                else{
                    JOptionPane.showMessageDialog(jPanelLogin, "Not valid Password length ,Should it Length\nis more than 6 OR Password has (*,/,=,+,...)\n                    Try Again :(");
                    jPanelWrongPass.setVisible(true);
                }
            }
            else{
                JOptionPane.showMessageDialog(jPanelLogin, "Not valid Input for Email Try Again :(");
                jPanelWrongEmail.setVisible(true);
            }
        }
        else
    ...
    private javax.swing.JLabel jLabelwrong1;
    private javax.swing.JLabel jLabelwrong2;
